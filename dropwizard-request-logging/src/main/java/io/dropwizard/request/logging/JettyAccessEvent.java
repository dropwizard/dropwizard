...
public class JettyAccessEvent implements IAccessEvent {
    ...
    private final SettableNullableLazy<String> threadName = new SettableNullableLazy<>(this::getThreadNameInternal);
    ...
    public String getThreadName() {
        return Optional.ofNullable(threadName.get()).orElse("-");
    }

    private String getThreadNameInternal() {
    ...
    private static final class SettableNullableLazy<T> implements Supplier<T> {
        private final Supplier<T> supplier;
        @Nullable
        private T value;
        private boolean initialized = false;
        ...
        public SettableNullableLazy(@NonNull Supplier<@Nullable T> supplier) {
            this.supplier = supplier;
        }
