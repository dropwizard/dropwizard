...
class LogbackClassicRequestLogFactoryTest {
    ...
    void setUp() throws Exception {
        ...
        this.requestLog = new YamlConfigurationFactory<>(
                        RequestLogFactory.class, BaseValidator.newValidator(), objectMapper, "dw")
                .build(new ResourceConfigurationSourceProvider(), "yaml/logbackClassicRequestLog.yml");
    }

    @Test
    void testDeserialized() {
        assertThat(requestLog).isInstanceOfSatisfying(LogbackClassicRequestLogFactory.class, logFactory -> assertThat(
                        logFactory)
                .satisfies(classicRequestLogFactory -> assertThat(classicRequestLogFactory.getTimeZone())
                        .isEqualTo(TimeZone.getTimeZone("Europe/Amsterdam")))
                .satisfies(classicRequestLogFactory -> assertThat(classicRequestLogFactory.getAppenders())
                        .hasSize(3)
