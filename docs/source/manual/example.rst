...
* ``java -jar ~/git/dropwizard/dropwizard-example/target/dropwizard-example-0.8.0-20140929.jar db migrate example.yml``
* The above ran the liquibase migration in /src/main/resources/migrations.xml, creating the table schema
* You can now start the app in your IDE by running ``java -jar ~/git/dropwizard/dropwizard-example/target/dropwizard-example-0.8.0-20140929.jar db migrate example.yml``
