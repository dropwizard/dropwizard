...
copyright = u'2010-2013, Coda Hale, Yammer Inc., 2014-2020 Dropwizard Team'
...
version_regex = re.match(r"(?P<major>\d+)\.(?P<minor>\d+).*", release)
version = "%s.%s" % (version_regex.group('major'), version_regex.group('minor'))
