...
class ConstraintViolationExceptionMapperTest extends AbstractJerseyTest {
    ...
    void postInvalidEntityIs422() {
        final Response response = target("/valid/foo")
    ...
    void postInvalidatedEntityIs422() {
        final Response response = target("/valid/fooValidated")
                .request(MediaType.APPLICATION_JSON)
                .post(Entity.entity("{}", MediaType.APPLICATION_JSON));
        assertThat(response.getStatus()).isEqualTo(422);
        assertThat(response.readEntity(String.class)).isEqualTo("{\"errors\":[\"name must not be empty\"]}");
    ...
    void postInvalidInterfaceEntityIs422() {
        final Response response = target("/valid2/repr")
                .request(MediaType.APPLICATION_JSON)
    ...
    void getInvalidReturnIs500() {
        ...
        final Response response =
                target("/valid/bar").queryParam("name", "dropwizard").request().get();
        assertThat(response.getStatus()).isEqualTo(500);
    ...
    void getInvalidQueryParamsIs400() {
        ...
        final Response response =
                target("/valid/bar").queryParam("name", "hi").request().get();
    ...
    void cacheIsForParamNamesOnly() {
        ...
        final Response response =
                target("/valid/fhqwhgads").queryParam("num", 2).request().get();
    ...
    void getInvalidCustomTypeIs400() {
        // query parameter is too short and so will fail validation
        final Response response =
                target("/valid/barter").queryParam("name", "hi").request().get();
    ...
    void postInvalidMethodClassIs422() {
        final Response response =
                target("/valid/nothing").request().post(Entity.entity("{}", MediaType.APPLICATION_JSON_TYPE));
        assertThat(response.getStatus()).isEqualTo(422);
    ...
    void getInvalidMatrixParamIs400() {
        final Response response =
                target("/valid/matrix").matrixParam("bob", "").request().get();
        assertThat(response.getStatus()).isEqualTo(400);
    ...
    void returnPartialValidatedRequestEntities() {
        final Response response =
                target("/valid/validatedPartialExample").request().post(Entity.json("{\"id\":1}"));
    ...
    void invalidNullPartialValidatedRequestEntities() {
        final Response response =
                target("/valid/validatedPartialExample").request().post(Entity.json(null));
    ...
    void invalidEntityExceptionForPartialValidatedRequestEntities() {
        final Response response =
                target("/valid/validatedPartialExampleBoth").request().post(Entity.json("{\"id\":1}"));
    ...
    void invalidNullPartialBothValidatedRequestEntities() {
        final Response response =
                target("/valid/validatedPartialExampleBoth").request().post(Entity.json(null));
    ...
    void returnPartialBothValidatedRequestEntities() {
        final Response response = target("/valid/validatedPartialExampleBoth")
                .request()
                .post(Entity.json("{\"id\":1,\"text\":\"hello Cemo\"}"));
    ...
    void returnRequestArrayEntities() {
        final Response response =
                target("/valid/validExampleArray").request().post(Entity.json("[{\"id\":1}, {\"id\":2}]"));
    ...
    void invalidRequestCollectionEntities() {
        final Response response =
                target("/valid/validExampleCollection").request().post(Entity.json("[{\"id\":-1}, {\"id\":-2}]"));

        assertThat(response.getStatus()).isEqualTo(422);
        assertThat(response.readEntity(String.class))
                .contains("id must be greater than or equal to 0", "id must be greater than or equal to 0");
    }
    ...
    void invalidRequestSetEntities() {
        final Response response =
                target("/valid/validExampleSet").request().post(Entity.json("[{\"id\":1}, {\"id\":-2}]"));
        assertThat(response.getStatus()).isEqualTo(422);
        assertThat(response.readEntity(String.class)).containsOnlyOnce("id must be greater than or equal to 0");
    }
    ...
    void invalidRequestListEntities() {
        final Response response =
                target("/valid/validExampleList").request().post(Entity.json("[{\"id\":-1}, {\"id\":-2}]"));
        assertThat(response.getStatus()).isEqualTo(422);
        assertThat(response.readEntity(String.class))
                .isEqualTo("{\"errors\":[\"id must be greater than or equal to 0\","
    ...
    void returnsValidatedMapRequestEntities() {
        final Response response = target("/valid/validExampleMap")
                .request()
                .post(Entity.json("{\"one\": {\"id\":1}, \"two\": {\"id\":2}}"));
    ...
    void returnsValidatedEmbeddedListEntities() {
        final Response response = target("/valid/validExampleEmbeddedList")
                .request()
                .post(Entity.json("[ {\"examples\": [ {\"id\":1 } ] } ]"));
    ...
    void testInvalidFieldQueryParam() {
        final Response response =
                target("/valid/bar").queryParam("sort", "foo").request().get();
    ...
    void invalidBeanParamEnumParameter() {
        final Response response =
                target("/valid/zoo").queryParam("choice", "invalid").request().get();
        assertThat(response.getStatus()).isEqualTo(400);
        assertThat(response.readEntity(String.class))
                .containsOnlyOnce("query param choice must be one of [OptionA, OptionB, OptionC]");
    }
    ...
    void selfValidatingPayloadInvalid() {
        final Response response =
                target("/valid/selfValidatingPayload").request().post(Entity.json("{\"answer\":100}"));
    ...
    void selfValidatingPayloadSuccess() {
        ...
        final Response response =
                target("/valid/selfValidatingPayload").request().post(Entity.json(payload));
    ...
    void longParam_fails_with_null() {
        final Response response =
                target("/valid/longParam").queryParam("num").request().get();
    ...
    void longParam_fails_with_constraint_violation() {
        final Response response =
                target("/valid/longParam").queryParam("num", 5).request().get();
    ...
    void longParam_fails_with_string() {
        final Response response =
                target("/valid/longParam").queryParam("num", "string").request().get();
    ...
    void longParam_succeeds() {
        final Response response =
                target("/valid/longParam").queryParam("num", 42).request().get();
    ...
    void longParamNotNull_fails_with_null() {
        final Response response =
                target("/valid/longParamNotNull").queryParam("num").request().get();
    ...
    void longParamNotNull_fails_with_constraint_violation() {
        final Response response =
                target("/valid/longParamNotNull").queryParam("num", 5).request().get();
    ...
    void intParam_fails_with_null() {
        final Response response =
                target("/valid/intParam").queryParam("num").request().get();
    ...
    void intParam_fails_with_constraint_violation() {
        final Response response =
                target("/valid/intParam").queryParam("num", 5).request().get();
    ...
    void intParam_fails_with_string() {
        final Response response =
                target("/valid/intParam").queryParam("num", "string").request().get();
    ...
    void intParam_succeeds() {
        final Response response =
                target("/valid/intParam").queryParam("num", 42).request().get();
    ...
    void intParamNotNull_fails_with_null() {
        final Response response =
                target("/valid/intParamNotNull").queryParam("num").request().get();
    ...
    void intParamNotNull_fails_with_constraint_violation() {
        final Response response =
                target("/valid/intParamNotNull").queryParam("num", 5).request().get();
    ...
    void intParamNotNull_succeeds() {
        final Response response =
                target("/valid/intParamNotNull").queryParam("num", 42).request().get();
    ...
    void intParamWithDefault_succeeds_with_null() {
        final Response response =
                target("/valid/intParamWithDefault").queryParam("num").request().get();
    ...
    void intParamWithOptionalInside_fails_with_missing() {
        final Response response =
                target("/valid/intParamWithOptionalInside").request().get();
    ...
    void optionalInt_fails_with_empty_string() {
        final Response response =
                target("/valid/optionalInt").queryParam("num", "").request().get();
    ...
    void optionalInt_fails_with_constraint_violation() {
        final Response response =
                target("/valid/optionalInt").queryParam("num", 5).request().get();
    ...
    void optionalInt_fails_with_string() {
        final Response response =
                target("/valid/optionalInt").queryParam("num", "test").request().get();
    ...
    void optionalInt_succeeds() {
        final Response response =
                target("/valid/optionalInt").queryParam("num", 30).request().get();
    ...
    void optionalIntWithDefault_succeeds_with_missing() {
        final Response response =
                target("/valid/optionalIntWithDefault").request().get();
    ...
    void optionalInteger_succeeds_with_empty_string() {
        final Response response =
                target("/valid/optionalInteger").queryParam("num", "").request().get();
    ...
    void optionalInteger_fails_with_constraint_violation() {
        final Response response =
                target("/valid/optionalInteger").queryParam("num", 5).request().get();
    ...
    void optionalInteger_succeeds() {
        final Response response =
                target("/valid/optionalInteger").queryParam("num", 30).request().get();
    ...
    void optionalIntegerWithDefault_succeeds_with_missing() {
        final Response response =
                target("/valid/optionalIntegerWithDefault").request().get();
