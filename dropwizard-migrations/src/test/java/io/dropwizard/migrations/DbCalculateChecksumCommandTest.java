...
class DbCalculateChecksumCommandTest {
    ...
    private final DbCalculateChecksumCommand<TestMigrationConfiguration> migrateCommand =
            new DbCalculateChecksumCommand<>(
    ...
    void testHelpPage() throws Exception {
        ...
        MigrationTestSupport.createSubparser(migrateCommand)
                .printHelp(new PrintWriter(new OutputStreamWriter(out, UTF_8), true));
        assertThat(out.toString(UTF_8.name()))
                .isEqualToNormalizingNewlines("usage: db calculate-checksum [-h] [--migrations MIGRATIONS-FILE]\n"
