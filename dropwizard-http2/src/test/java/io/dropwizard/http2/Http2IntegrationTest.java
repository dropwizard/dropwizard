...
class Http2IntegrationTest extends Http2TestCommon {
    ...
    final DropwizardAppExtension<Configuration> appRule = new DropwizardAppExtension<>(
            ...
            ConfigOverride.config(
                    "tls_http2", "server.connector.keyStorePath", resourceFilePath("stores/http2_server.jks")),
            ConfigOverride.config(
                    "tls_http2", "server.connector.trustStorePath", resourceFilePath("stores/http2_client.jts")));
