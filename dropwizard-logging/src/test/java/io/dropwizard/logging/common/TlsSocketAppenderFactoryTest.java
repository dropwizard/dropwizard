...
class TlsSocketAppenderFactoryTest {
    ...
    void testParseCustomConfiguration() throws Exception {
        DefaultLoggingFactory loggingFactory = yamlConfigurationFactory.build(
                new ResourceConfigurationSourceProvider(), "yaml/logging-tls-custom.yml");
        assertThat(loggingFactory.getAppenders())
                ...
                .isInstanceOfSatisfying(TlsSocketAppenderFactory.class, appenderFactory -> assertThat(appenderFactory)
                        ...
                        .satisfies(
                                factory -> assertThat(factory.getKeyStorePath()).isEqualTo("/path/to/keystore.p12"))
                        .satisfies(factory ->
                                assertThat(factory.getKeyStorePassword()).isEqualTo("keystore_pass"))
                        .satisfies(
                                factory -> assertThat(factory.getKeyStoreType()).isEqualTo("PKCS12"))
                        .satisfies(factory ->
                                assertThat(factory.getKeyStoreProvider()).isEqualTo("BC"))
                        .satisfies(factory ->
                                assertThat(factory.getTrustStorePath()).isEqualTo("/path/to/trust_store.jks"))
                        .satisfies(factory ->
                                assertThat(factory.getTrustStorePassword()).isEqualTo("trust_store_pass"))
                        .satisfies(factory ->
                                assertThat(factory.getTrustStoreType()).isEqualTo("JKS"))
                        .satisfies(factory ->
                                assertThat(factory.getTrustStoreProvider()).isEqualTo("SUN"))
                        .satisfies(
                                factory -> assertThat(factory.getJceProvider()).isEqualTo("Conscrypt"))
                        .satisfies(
                                factory -> assertThat(factory.isValidateCerts()).isTrue())
                        .satisfies(
                                factory -> assertThat(factory.isValidatePeers()).isTrue())
                        .satisfies(factory ->
                                assertThat(factory.getSupportedProtocols()).containsExactly("TLSv1.1", "TLSv1.2"))
                        .satisfies(factory ->
                                assertThat(factory.getExcludedProtocols()).isEmpty())
                        ...
                        .satisfies(factory ->
                                assertThat(factory.getExcludedCipherSuites()).isEmpty()));
    }
