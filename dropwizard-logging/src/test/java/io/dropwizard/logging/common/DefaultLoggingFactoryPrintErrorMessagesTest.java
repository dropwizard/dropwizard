...
class DefaultLoggingFactoryPrintErrorMessagesTest {
    ...
    @Test
    void testWhenFileAppenderDoesNotHaveWritePermissionToFolder_PrintsErrorMessageToConsole(@TempDir Path tempDir)
            throws Exception {
        File folderWithoutWritePermission =
                tempDir.resolve("folder-without-write-permission").toFile();
    ...
    @Test
    void testWhenSettingUpLoggingWithValidConfiguration_NoErrorMessageIsPrintedToConsole(@TempDir Path tempDir)
            throws Exception {
        File folderWithWritePermission =
                tempDir.resolve("folder-with-write-permission").toFile();
    ...
    void testLogbackStatusPrinterPrintStreamIsRestoredToSystemOut() throws Exception {
        ...
        assertThat(field.get(null)).isInstanceOfSatisfying(PrintStream.class, printStream -> assertThat(printStream)
                .isSameAs(System.out));
    }
}
