...
class ServletHealthResponderFactoryTest {
    ...
    void testBuildHealthServlet() throws Exception {
        // given
        HealthResponderFactory factory = configFactory.build(
                new ResourceConfigurationSourceProvider(), "/yml/servlet-responder-factory-caching.yml");
        ...
        factory.configure(
                NAME,
                Collections.singletonList(HEALTH_CHECK_URI),
    ...
    void testBuildHealthServletWithCacheControlDisabled() throws Exception {
        ...
        HealthResponderFactory factory = configFactory.build(
                ...
                "/yml/servlet-responder-factory-caching-header-disabled.yml");
        setupServletStubbing();
    ...
    private void setupServletStubbing() {
        ...
        when(servletRegistration.addMapping(HEALTH_CHECK_URI)).thenReturn(Collections.singleton(HEALTH_CHECK_URI));
    }
}
