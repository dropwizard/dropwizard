...
public class InstrumentedSpdyConnector extends HTTPSPDYServerConnector {
    private final Timer duration;
    private final Meter accepts, connects, disconnects;
    private final Counter connections;

    public InstrumentedSpdyConnector(int port) {
        this(Metrics.defaultRegistry(), port);
    }

    public InstrumentedSpdyConnector(MetricsRegistry registry,
                                                 int port) {
        super();
        setPort(port);
    ...
    public InstrumentedSpdyConnector(SslContextFactory contextFactory, int port) {
        this(contextFactory, Metrics.defaultRegistry(), port);
    }

    public InstrumentedSpdyConnector(SslContextFactory contextFactory, MetricsRegistry registry, int port) {
