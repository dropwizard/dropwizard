 ...
 * to be used with MergedConfiguration classes.
 */
public final class MergedConfigurationParsingException extends ConfigurationException {
    
    /**
     * A class for building a MergedConfigurationParsingException
     *
     */
    static class Builder {
        ...
        /**
         * Set a cause and return it
         * 
         * @param newCause
         * @return 
         */
        Builder setCause(Exception newCause) {
            this.cause = newCause;
            return this;
        }

        /**
         * Set a detail and return it
         * 
         * @param newDetail
         * @return 
         */
        Builder setDetail(String newDetail) {
            this.detail = newDetail;
            return this;
        }

        /**
         * Set a field path and return it
         * 
         * @param newFieldPath
         * @return 
         */
        Builder setFieldPath(List<JsonMappingException.Reference> newFieldPath) {
            this.fieldPath = newFieldPath;
            return this;
        }

        /**
         * Set a location and return it
         * 
         * @param location
         * @return 
         */
         ...
         * @return 
         */
        Builder setLocation(int newLine, int newColumn) {
            this.line = newLine;
        ...
        /**
         * Add a suggestion and return it
         * 
         * @param newSuggestion
         * @return 
         */
        Builder addSuggestion(String newSuggestion) {
        ...
        /**
         * Add suggestions and return it
         * 
         * @param newSuggestions
         * @return 
         */
        Builder addSuggestions(Collection<String> newSuggestions) {
            this.suggestionsSorted = false;
        ...
        /**
         * Set a suggestion base and return it
         * 
         * @param base
         * @return 
         */
        ...
        /**
         * Build an exception by path
         * 
         * @param path
         * @return 
         */
        MergedConfigurationParsingException build(String path) {
            ...
            if (hasSuggestions()) {
                List<String> suggestionList = getSuggestions();
            ...
            return hasCause()
                    ? new MergedConfigurationParsingException(path, sb.toString(), getCause())
                    : new MergedConfigurationParsingException(path, sb.toString());
        }
        ...
        /**
         * Class for computing Levenshtein distance of two strings
         */
        private static class LevenshteinComparator implements Comparator<String>, Serializable {
            ...
            /**
             * Create a new LevenshteinComparator
             * 
             * @param base 
             */
     ...
     */
    private MergedConfigurationParsingException(String path, String msg) {
     ...
     */
    private MergedConfigurationParsingException(String path, String msg, Throwable cause) {
