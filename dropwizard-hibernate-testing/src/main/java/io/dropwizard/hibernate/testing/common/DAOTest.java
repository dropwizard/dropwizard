package io.dropwizard.hibernate.testing.common;
...
public class DAOTest {
    ...
    public static abstract class Builder<B extends Builder<B>> {
        ...
        protected DAOTest buildDAOTest() {
            ...
            ClusteredSessionFactory clusteredSessionFactory = new ClusteredSessionFactory(sessionFactory, sessionFactory);

            return new DAOTest(clusteredSessionFactory);
        }
    }

    private final ClusteredSessionFactory clusteredSessionFactory;
    private final SessionFactory sessionFactory;

    /**
     * Use {@link DAOTestRule#newBuilder()}
     */
    private DAOTest(ClusteredSessionFactory clusteredSessionFactory) {
        this.clusteredSessionFactory = clusteredSessionFactory;
    ...
    public ClusteredSessionFactory getSessionFactory() {
        return clusteredSessionFactory;
    }
