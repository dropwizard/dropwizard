...
public class HttpConnectorFactoryTest {
    ...
    public void testParseMinimalConfiguration() throws Exception {
        ...
        assertThat(http.getOutputBufferSize()).isEqualTo(Size.kibibytes(32));
        assertThat(http.getMaxRequestHeaderSize()).isEqualTo(Size.kibibytes(8));
        assertThat(http.getMaxResponseHeaderSize()).isEqualTo(Size.kibibytes(8));
        assertThat(http.getInputBufferSize()).isEqualTo(Size.kibibytes(8));
        ...
        assertThat(http.getMaxBufferPoolSize()).isEqualTo(Size.kibibytes(64));
    ...
    public void testParseFullConfiguration() throws Exception {
        ...
        assertThat(http.getOutputBufferSize()).isEqualTo(Size.kibibytes(128));
        assertThat(http.getMaxRequestHeaderSize()).isEqualTo(Size.kibibytes(4));
        assertThat(http.getMaxResponseHeaderSize()).isEqualTo(Size.kibibytes(4));
        assertThat(http.getInputBufferSize()).isEqualTo(Size.kibibytes(4));
        ...
        assertThat(http.getMaxBufferPoolSize()).isEqualTo(Size.kibibytes(32));
