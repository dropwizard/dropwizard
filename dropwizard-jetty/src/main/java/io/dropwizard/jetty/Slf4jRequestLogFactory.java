 ...
 */
@JsonTypeName("slf4j")
public class Slf4jRequestLogFactory implements RequestLogFactory {
    ...
    public Optional<? extends RequestLog> build(String name) {
        if (!isEnabled()) {
        ...
        return Optional.of(new Slf4jRequestLog(attachable, timeZone));
    }
}
