...
class JerseyIgnoreRequestUserAgentHeaderFilterTest {
    public static final DropwizardAppExtension<Configuration> APP_RULE = new DropwizardAppExtension<>(
            ...
            JerseyIgnoreRequestUserAgentHeaderFilterTest.class
                    .getResource("/yaml/jerseyIgnoreRequestUserAgentHeaderFilterTest.yml")
                    .getPath());
    ...
    void clientIsNotSetRequestIsSet() {
        assertThat(clientBuilder
                        ...
                        .target(testUri + "/user_agent")
                        .request()
                        .header("User-Agent", "RequestUserAgentHeaderValue")
                        .get(String.class))
