...
class SubResourcesTest {
    ...
    void canReadFromTopResource() {
        final Person person = appExtension
                .client()
                .target(baseUri())
                .path("/people/Greg")
                .request()
    ...
    void canWriteTopResource() {
        final Person person = appExtension
                ...
                .post(
                        Entity.entity(
                                "{\"name\": \"Jason\", \"email\": \"jason@gmail.com\", \"birthday\":637317407000}",
    ...
    void errorsAreHandled() {
        Response response = appExtension
                .client()
                .target(baseUri())
    ...
    public static class TestApplication extends Application<TestConfiguration> {
        ...
        public void run(TestConfiguration configuration, Environment environment) {
            ...
            environment
                    .jersey()
                    .register(new PersonResource(new PersonDAO(sessionFactory), new DogDAO(sessionFactory)));
        }
    ...
    public static class DogResource {
        ...
        @Path("{dogName}")
        @UnitOfWork(readOnly = true)
        public Optional<Dog> find(@PathParam("ownerName") String ownerName, @PathParam("dogName") String dogName) {
